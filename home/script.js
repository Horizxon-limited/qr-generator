...
submit.addEventListener('click',()=>{
    ...
    if (input.value.length == 0) {
        ...
        let apiLink = `https://api.qrserver.com/v1/create-qr-code/?size=250x250&margin=30&data=${encodeURIComponent(fetchedData)}`;
        ...
        fetch(apiLink)
            ...
            .catch(error => {
                ...
                alert('Unable to generate QR code. Please disable your ad blocker or try a different browser.');
